...
Item {
    ...
    property alias gridStrings: gridStrings
    ...
    Item {
        ...
        ComboboxEx {
            ...
            clip: false
            hoverEnabled: true
            model: (dbgManager !== null) ? dbgManager.otherTypeCategoryGroupCapt : null;
        }
    }
    ...
    ScrollView {
        ...
        GridLayout {
            ...
            Repeater {
                ...
                //Layout.margins: 1
                model: (dbgManager !== null) ? dbgManager.otherTypeListDisp : null
