...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Ftp" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Ftp_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Ftp)
    ...
    macro(_populate_Ftp_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Ftp_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Ftp_check_file_exists(${imported_location})
