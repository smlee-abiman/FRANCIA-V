#ifndef NCPCOMMANDINC_H
#define NCPCOMMANDINC_H
...
// NCPCommandInc.
//------------------------------------------------------
class NCPCommandInc : public NCPCommand
{
    Q_OBJECT
public:
    explicit NCPCommandInc(QObject *parent = nullptr);
    explicit NCPCommandInc(ResourceManager *resource, QObject *parent = nullptr);
    ...
    virtual int type() const override { return Type::Inc; }
