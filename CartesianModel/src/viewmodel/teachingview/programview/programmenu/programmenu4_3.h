#ifndef PROGRAMMENU4_3_H
#define PROGRAMMENU4_3_H
...
// ProgramMenu4_3.
//------------------------------------------------------
class ProgramMenu4_3 : public ProgramMenu
{
    Q_OBJECT
    Q_PROPERTY(QList<QObject *> subMenuList READ subMenuList CONSTANT)

public:
    explicit ProgramMenu4_3(ResourceManager *resource,CommunicationThread *comm);
    ~ProgramMenu4_3() override;
