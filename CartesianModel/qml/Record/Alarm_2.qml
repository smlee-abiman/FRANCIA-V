...
**************************************************************************************/
Item {
    id: system_alarm_view
    property var viewModel: alarmHistoryViewModel
    property var alarmList: viewModel.systemAlarmList
    ...
    readonly property int system_alarm_msg_type_start_index: 510
...
Rectangle {
    ...
    Component{
        ...
        Rectangle{
            ...
            Text{
                property int alarmNo: system_alarm_msg_type_start_index + modelData.alarmNo * 2 - 1
                width: 420
                height: parent.height
                x:330
...
Rectangle {
    ...
    Rectangle {
        ...
        PageText {
            anchors.centerIn: parent
            page: system_alarm_view.page
            totalPage: system_alarm_view.numPages
            color: "#666666"
        }
    }
...
Rectangle {
    ...
    Loader {
        ...
        enabled: system_alarm_view.pageActive
