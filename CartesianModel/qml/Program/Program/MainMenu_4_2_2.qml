...
Rectangle{
    ...
    QtObject {
        ...
        readonly property var menuModel: menu42Model.subMenuList[1]     // ProgramMenu4_2_2
        readonly property int menuIndex: menuModel.menuIndex
        readonly property bool condition: (menuIndex === 1)
        readonly property int labelNo: menuModel.labelNo
        readonly property bool dialogOpend: menuModel.openLabelSelectionDialog
    ...
    Rectangle{
        ...
        Row{
            ...
            Text{
                ...
                color:"black"
                text: resourceManager.label(41,543, language.value)
            }
            Rectangle{
                width: 170
                height: 40
                ...
                Text{
                    ...
                    text: (1 <= local.labelNo) ? "L" + ('000' + local.labelNo).slice(-3) : ""
                }
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        local.menuModel.openLabelSelectionDialog = true
                    }
                }
            }
        }
                ...
                Rectangle{
                    ...
                    Rectangle{
                        ...
                        Text{
                            ...
                            verticalAlignment: Text.AlignVCenter
                            horizontalAlignment: Text.AlignHCenter
                            font.pixelSize: mouse_xxxx.pressed ? 19 : 20
                            font.bold: true
                            visible: base.item.selectState
