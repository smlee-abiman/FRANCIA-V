...
Rectangle{
    ...
    QtObject {
        ...
        property var menuModel: programViewModel.progMenu2.subMenuList[3].subMenuList[1]
        property var pointDataList: menuModel.pointDataList
        property bool consecutive: menuModel.consecutive
        property int halfwayPointNo: menuModel.halfwayPointNo
        property int endPointNo: menuModel.endPointNo
        property bool isEndPoint: menuModel.isEndPoint
    ...
    Component{
        ...
        Rectangle{
            ...
            LimitNumericEditBox {
                ...
                anchors.verticalCenter: parent.verticalCenter
                borderColor: "#999999"
                color: !local.isEndPoint ? "white" : "#cccccc"
                enabled: pointData.select && !local.isEndPoint
                keyLayoutType: 6
                enablePressAndHoldClearKey: true
                value: local.menuModel.formatPosition(pointData.halfwayPosition)
                onReady: {
                    max = commonViewModel.formatPointMaxValue(axisType, local.halfwayPointNo)
                    min = commonViewModel.formatPointMinValue(axisType, local.halfwayPointNo)
                }
                onEnter: {
                    ...
                    local.menuModel.setHalfwayPosition(axisType, position)
            ...
            LimitNumericEditBox {
                ...
                keyLayoutType: 6
                enablePressAndHoldClearKey: true
                value: local.menuModel.formatPosition(pointData.endPosition)
                onReady: {
                    max = commonViewModel.formatPointMaxValue(axisType, local.endPointNo)
                    min = commonViewModel.formatPointMinValue(axisType, local.endPointNo)
                }
                onEnter: {
                    let position = parseFloat(newValue)
                    if (position !== Utils.INVALID_POSITION_VALUE) {
                    ...
                    local.menuModel.setEndPosition(axisType, position)
                    commonViewModel.modbusMemblemSwControl(true, Enums.TenkeyInputValid)
                    commonViewModel.modbusMemblemSwControl(false, Enums.TenkeyInputValid)
                }
            }
    ...
    Rectangle{
        ...
        Row{
            ...
            Rectangle{
                ...
                width:80
                height: 30
                color: !local.isEndPoint ?  "#cc3333" : "#cccccc"
                border.color: "#999999"
                Text{
                    anchors.centerIn: parent
                    font.pixelSize: 17
                    font.bold: true
                    text: resourceManager.label(41,523, language.value)
                    color: "black"
                }
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        local.menuModel.isEndPoint = false
                    }
                }
            }
            Rectangle{
                ...
                Text{
                    ...
                    font.pixelSize: 17
                    font.bold: true
                    text: resourceManager.label(41,524, language.value)
                    color: "black"
                }
                MouseArea{
                    anchors.fill: parent
                    onClicked: {
                        local.menuModel.isEndPoint = true
                    }
                }
            }
        }
    ...
    Rectangle{
        ...
        Row{
            ...
            Text{
                ...
                horizontalAlignment: Text.AlignLefti
                anchors.verticalCenter: parent.verticalCenter
        ...
        Rectangle {
            ...
            Text{
                ...
                wrapMode:Text.WordWrap
                font.pixelSize: positionMemoryButtonMouseArea.pressed ? 18 : 18
