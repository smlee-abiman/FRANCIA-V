...
Item{
    ...
    QtObject {
        ...
        readonly property var menuModel: menu43Model.subMenuList[3]     // ProgramMenu4_3_4
        readonly property var countType4Addr: menuModel.countType4Addr
        readonly property int selectedCountType4Addr: menuModel.selectedCountType4Addr

        readonly property int numOfItems: countType4Addr.length
        readonly property int numOfItemsParPage: 8
        readonly property int numOfPages: Math.ceil(numOfItems / numOfItemsParPage)
        property int currentPage: 0

        onSelectedCountType4AddrChanged: {
            let index = countType4Addr.indexOf(selectedCountType4Addr)
            gotoPage(index)
        }

        function initialize() {
            currentPage = 0
            menuModel.selectedCountType4Addr = -1
        }
        function prevPage() {
    ...
    Component{
        ...
        Rectangle{
            ...
            width: 310
            height: 47
            readonly property int ioAddress: local.countType4Addr[index]
            readonly property bool isSelected: (ioAddress === local.menuModel.selectedCountType4Addr)
            ...
            CheckBox{
                ...
                onClicked:{
                    local.menuModel.selectedCountType4Addr = isSelected ? -1 : ioAddress
                }
            }
        }
    }
