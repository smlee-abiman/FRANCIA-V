...
Rectangle {
    ...
    property int verticalWidth200ms:25
    property int horizontalWidth200ms:32
    property int verticalWidth500ms:25
    property double horizontalWidth500ms:12.8
    property int verticalWidth1s:25
    property double horizontalWidth1s:12.8
    property int verticalWidth2s:25
    property double horizontalWidth2s:12.8
    property int axisIndex:0
    property int speedPeakData:0
    property int torquePeakData:0
    ...
    Shape{
        ...
        ShapePath{
            ...
            startX: 0
            startY: 25
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 0 }
            PathMove { x: 0;    y: 25 + root.verticalWidth200ms * 1 }
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 1 }
            PathMove { x: 0;    y: 25 + root.verticalWidth200ms * 2 }
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 2 }
            PathMove { x: 0;    y: 25 + root.verticalWidth200ms * 3 }
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 3 }
            PathMove { x: 0;    y: 25 + root.verticalWidth200ms * 4 }
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 4 }
            PathMove { x: 0;    y: 25 + root.verticalWidth200ms * 5 }
            PathLine { x: 783;  y: 25 + root.verticalWidth200ms * 5 }
    ...
    Shape{
        ...
        ShapePath{
            ...
            startX: 0
            startY: 25
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 0 }
            PathMove { x: 0;    y: 25 + root.verticalWidth500ms * 1 }
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 1 }
            PathMove { x: 0;    y: 25 + root.verticalWidth500ms * 2 }
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 2 }
            PathMove { x: 0;    y: 25 + root.verticalWidth500ms * 3 }
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 3 }
            PathMove { x: 0;    y: 25 + root.verticalWidth500ms * 4 }
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 4 }
            PathMove { x: 0;    y: 25 + root.verticalWidth500ms * 5 }
            PathLine { x: 783;  y: 25 + root.verticalWidth500ms * 5 }
    ...
    Shape{
        ...
        ShapePath{
            ...
            startX: 0
            startY: 25
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 0 }
            PathMove { x: 0;    y: 25 + root.verticalWidth1s * 1 }
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 1 }
            PathMove { x: 0;    y: 25 + root.verticalWidth1s * 2 }
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 2 }
            PathMove { x: 0;    y: 25 + root.verticalWidth1s * 3 }
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 3 }
            PathMove { x: 0;    y: 25 + root.verticalWidth1s * 4 }
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 4 }
            PathMove { x: 0;    y: 25 + root.verticalWidth1s * 5 }
            PathLine { x: 783;  y: 25 + root.verticalWidth1s * 5 }
    ...
    Shape{
        ...
        ShapePath{
            ...
            startX: 0
            startY: 25
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 0 }
            PathMove { x: 0;    y: 25 + root.verticalWidth2s * 1 }
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 1 }
            PathMove { x: 0;    y: 25 + root.verticalWidth2s * 2 }
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 2 }
            PathMove { x: 0;    y: 25 + root.verticalWidth2s * 3 }
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 3 }
            PathMove { x: 0;    y: 25 + root.verticalWidth2s * 4 }
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 4 }
            PathMove { x: 0;    y: 25 + root.verticalWidth2s * 5 }
            PathLine { x: 783;  y: 25 + root.verticalWidth2s * 5 }
    ...
    function requestPaintBlue(startIndex){
    ...
    function requestPaintRed(startIndex){
        graphCanvas.startIndex = startIndex
